        <div class="nav-header">
			<a href="index.html" class="brand-logo">
				...
				<div class="brand-title">
					<h2 class="">SISAKAD.</h2> <span class="brand-sub-title">@sisakad</span> </div>
			</a>
					...
					<div class="tab-pane fade active show" id="chat" role="tabpanel">
									...
									<li class="name-first-letter">A</li>
										<li class="dlab-chat-user">
											<div class="d-flex bd-highlight">
												<div class="img_cont"> <img src="images/avatar/5.jpg" class="rounded-circle user_img" alt=""> <span class="online_icon offline"></span> </div>
												<div class="user_info"> <span>Amierrudin</span>
						...
						<div class="card chat dlab-chat-history-box d-none">
							...
							<div class="card-header chat-list-header text-center">
								...
								<div>
									<h6 class="mb-1">Chat with Amierrudin</h6>
						...
						<div class="card mb-sm-3 mb-md-0 note_card">
							...
							<div class="card-body contacts_body p-0 dlab-scroll" id="DLAB_W_Contacts_Body2">
								<ul class="contacts">
									<li class="active">
										<div class="d-flex bd-highlight">
											<div class="user_info"> <span>PPDB 2022</span>
												<p>10 Aug 2022</p>
											</div>
											<div class="ms-auto"> <a href="javascript:void(0);" class="btn btn-primary btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a> <a href="javascript:void(0);" class="btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a> </div>
										</div>
									</li>
								</ul>
							</div>
							{{-- End Content Notifikasi --}}
						</div>
					</div>
				</div>
			</div>
						...
						<ul class="navbar-nav header-right">
							<li class="nav-item d-flex align-items-center">
								<div class="input-group search-area">
									<input type="text" class="form-control" placeholder="Search here..."> <span class="input-group-text"><a href="javascript:void(0)"><i class="flaticon-381-search-2"></i></a></span> </div>
							</li>
							{{-- Notifikasi --}}
							<li class="nav-item dropdown notification_dropdown">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									...
									</svg> <span class="badge light text-white bg-warning rounded-circle">1</span> </a>
											...
											<li>
												<div class="timeline-panel">
													...
													<div class="media-body">
														<h6 class="mb-1">Pengumuman : UAS</h6> <small class="d-block">29 April 2022 - 02:26 PM</small> </div>
												</div>
											</li>
										</ul>
									</div> <a class="all-notification" href="javascript:void(0);">See all notifications <i class="ti-arrow-end"></i></a> </div>
							</li>
							{{-- End Notifikasi --}}
							{{-- Chat/Notes --}}
							<li class="nav-item dropdown notification_dropdown">
								<a class="nav-link bell-link " href="javascript:void(0);">
									...
									</svg> <span class="badge light text-white bg-danger rounded-circle">2</span> </a>
							</li>
							{{-- End Chat/Notes --}}
							{{-- Profile Dropdown --}}
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"> <img src="../img/male.jpg" width="56" alt=""> </a>
								<div class="dropdown-menu dropdown-menu-end">
									...
									<a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg> &nbsp; Log Out</a>
